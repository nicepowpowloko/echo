<?php
require '/laragon/www/echo/include/header.php'
?>
...
<p><?= $product->prix?> €</p>
<a class='addpanier' href="../include/addpanier.php?id=<?= $product->id?>" >Ajouter</a>
</div>
...
<?php
require '/laragon/www/echo/include/footer.php'
?>