<?php
require '/laragon/www/echo/include/_header.php';
?>
...
?>
    ...
    <td><a href="./panier.php?delPanier=<?= $prodss->id; ?>">Supprimer le produit</a></td>
    </tr>
...
<?php
include '/laragon/www/echo/include/footer.php';
?>